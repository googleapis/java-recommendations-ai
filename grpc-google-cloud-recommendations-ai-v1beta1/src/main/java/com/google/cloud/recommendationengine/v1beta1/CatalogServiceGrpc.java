...
public final class CatalogServiceGrpc {
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.recommendationengine.v1beta1.CatalogItem
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("CreateCatalogItem"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.recommendationengine.v1beta1.CatalogItem
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("GetCatalogItem"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.recommendationengine.v1beta1.ListCatalogItemsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("ListCatalogItems"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.recommendationengine.v1beta1.CatalogItem
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("UpdateCatalogItem"))
                      .build();
        }
      }
    }
          ...
          CatalogServiceGrpc.getDeleteCatalogItemMethod =
              getDeleteCatalogItemMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("DeleteCatalogItem"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getImportCatalogItemsMethod = CatalogServiceGrpc.getImportCatalogItemsMethod) == null) {
      synchronized (CatalogServiceGrpc.class) {
        if ((getImportCatalogItemsMethod = CatalogServiceGrpc.getImportCatalogItemsMethod)
            == null) {
          CatalogServiceGrpc.getImportCatalogItemsMethod =
              getImportCatalogItemsMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new CatalogServiceMethodDescriptorSupplier("ImportCatalogItems"))
                      .build();
        }
      }
    }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DELETE_CATALOG_ITEM:
          serviceImpl.deleteCatalogItem(
              (com.google.cloud.recommendationengine.v1beta1.DeleteCatalogItemRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_IMPORT_CATALOG_ITEMS:
          serviceImpl.importCatalogItems(
              (com.google.cloud.recommendationengine.v1beta1.ImportCatalogItemsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
